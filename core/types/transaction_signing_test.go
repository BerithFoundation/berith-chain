...
func TestEIP155Signing(t *testing.T) {
	...
	tx, err := SignTx(NewTransaction(0, addr, new(big.Int), 0, new(big.Int), nil, Main, Main), signer, key)
	if err != nil {
		t.Fatal(err)
	}
...
func TestEIP155ChainId(t *testing.T) {
	...
	tx = NewTransaction(0, addr, new(big.Int), 0, new(big.Int), nil, Main, Main)
...
func TestChainId(t *testing.T) {
	...
	tx := NewTransaction(0, common.Address{}, new(big.Int), 0, new(big.Int), nil, Main, Main)
