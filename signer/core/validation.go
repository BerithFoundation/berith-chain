...
func (db *Database) ValidateTransaction(selector *string, tx *SendTxArgs) (*ValidationMessages, error) {
...
func (db *Database) ValidateCallData(selector *string, data []byte, messages *ValidationMessages) {
