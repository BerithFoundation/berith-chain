...
import (
	...
	bzzapi "bitbucket.org/ibizsoftware/berith-chain/swarm/api"
)
...
var tomlSettings = toml.Config{
	...
	MissingField: func(rt reflect.Type, field string) error {
		...
		if unicode.IsUpper(rune(rt.Name()[0])) && rt.PkgPath() != "main" {
			link = fmt.Sprintf(", check bitbucket.org/ibizsoftware/berith-chain/swarm/api/config.go for available fields")
		}
