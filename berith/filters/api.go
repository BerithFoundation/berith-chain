...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(berith.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as berith.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria berith.FilterQuery
...
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(berith.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
func (api *PublicFilterAPI) GetLogs(ctx context.Context, crit FilterCriteria) ([]*types.Log, error) {
	...
	if crit.BlockHash != nil {
		...
		// Convert the RPC block numbers into internals representations
