...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := berithdb.NewMemDatabase()
	finalDb := berithdb.NewMemDatabase()
...
// https://github.com/BerithFoundation/berith-chain/pull/15549.
func TestCopy(t *testing.T) {
	// Create a random state test to copy and modify "independently"
	orig, _ := New(common.Hash{}, NewDatabase(berithdb.NewMemDatabase()))
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(berithdb.NewMemDatabase()))
...
// See https://github.com/BerithFoundation/berith-chain/pull/15225#issuecomment-380191512
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(berithdb.NewMemDatabase()))
