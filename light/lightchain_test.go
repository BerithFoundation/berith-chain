...
func makeHeaderChain(parent *types.Header, n int, db berithdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (berithdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() berithdb.Database {
	return odr.db
}
