...
see https://bitbucket.org/ibizsoftware/berith-chain/issues/2040
Usage:

import (
 "bitbucket.org/ibizsoftware/berith-chain/common/httpclient"
 "bitbucket.org/ibizsoftware/berith-chain/swarm/api/http"
)
