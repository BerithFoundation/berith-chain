...
// *
// Response: Reply with random data generated by internals RNG
// @prev GetEntropy
type Entropy struct {
...
// *
// Request: Load seed and related internals settings from the computer
// @next ButtonRequest
// @next Success
// @next Failure
...
// Its position is shown only on device's internals display.
// @prev RecoveryDevice
// @prev WordAck
