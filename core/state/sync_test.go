...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(berithdb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db berithdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db berithdb.Database, root common.Hash) error {
...
func checkStateConsistency(db berithdb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, berithdb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(berithdb.Database), srcRoot)
