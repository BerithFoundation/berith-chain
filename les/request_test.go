...
type accessTestFn func(db berithdb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db berithdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db berithdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db berithdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db berithdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
