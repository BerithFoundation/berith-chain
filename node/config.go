...
type Config struct {
	...
	// used in the devp2p node identifier. The instance name of berith is "berith". If no
...
func (c *Config) ResolvePath(path string) string {
	...
	if warn, isOld := isOldBerithResource[path]; isOld {
		...
		if oldpath != "" && common.FileExist(oldpath) {
			if warn {
				c.warnOnce(&c.oldBerResourceWarning, "Using deprecated resource file %s, please move this file to the 'berith' subdirectory of datadir.", oldpath)
			}
			return oldpath
		}
	}
