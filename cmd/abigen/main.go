...
import (
	...
	"berith-chain/accounts/abi/bind"
	"berith-chain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Berith contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the Berith contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Berith contract Solidity source to build and bind")
