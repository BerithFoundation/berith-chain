...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (berithdb.Database, *BlockChain, error) {
	var (
...
func TestFastVsFullChains(t *testing.T) {
	...
	archiveDb := berithdb.NewMemDatabase()
	...
	fastDb := berithdb.NewMemDatabase()
...
//
// https://bitbucket.org/ibizsoftware/berith-chain/pull/15941
