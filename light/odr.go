...
type OdrRequest interface {
	StoreResult(db berithdb.Database)
}
...
func (req *TrieRequest) StoreResult(db berithdb.Database) {
	req.Proof.Store(db)
}
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db berithdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db berithdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BloomRequest) StoreResult(db berithdb.Database) {
